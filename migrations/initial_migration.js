...
var ExoLib = artifacts.require('./MultichainProof.sol');
...
const argv = require('yargs')
  ...
  .command('--MuPoS', 'Multichain Proof of Stake consensus mechanism.')
  .argv;
...
if (argv.live) {
  module.exports = function(deployer) {
    ...
    if (argv.token && argv.token != '') {
      ...
      deployer.deploy(EIP20, 1000000000000, 'Staking', 0, 'EXO')
