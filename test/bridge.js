...
const BridgeABI = require('../build/contracts/ExoBridge.json').abi;
const BridgeBytes = require('../build/contracts/ExoBridge.json').bytecode;
const tokenABI = require('../build/contracts/EIP20.json').abi;
const tokenBytes = require('../build/contracts/EIP20.json').bytecode;
const merkleLibBytes = require('../build/contracts/ExoBridgeProof.json').bytecode;
